...
CREATE TABLE `tbl_user_user_profile` (
  ...
  CONSTRAINT `FK_USER_PROFILE_ID` FOREIGN KEY (`USER_PROFILE_ID`) REFERENCES `tbl_user_profile` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_USER_USER_ID` FOREIGN KEY (`USER_ID`) REFERENCES `tbl_user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
